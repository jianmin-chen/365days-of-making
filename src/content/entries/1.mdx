...
Now it's time to put the Expo app to use! If you haven't installed it yet, install it on your phone - it's called _Expo Go_. If you're running it on an emulator, follow Expo's instructions for [Xcode](https://docs.expo.dev/workflow/ios-simulator/) and [Android Studio](https://docs.expo.dev/workflow/android-studio-emulator/).
...
<div className="thin-media">
  ...
  Native](/assets/images/2022-09-03-react-native-pokedex/starter.webp)
</div>
...
<div className="thin-media">
  ![Hello, World! is overlapping with the status
  bar](/assets/images/2022-09-03-react-native-pokedex/hello-world-broken.webp)
</div>
...
<div className="thin-media">
  ![A Pikachu preview
  card](/assets/images/2022-09-03-react-native-pokedex/preview-card.webp)
</div>
...
> _Sidenote_: Check out the React Native [documentation](https://reactnative.dev/docs/getting-started)! All the React documentation is so accessible and easy to read, and you'll definitely find it useful.
...
<div className="thin-media">
  ![Ten new cards each
  time](/assets/images/2022-09-03-react-native-pokedex/card-previews.webp)
</div>
...
<div className="thin-media">
  ...
  functionality](/assets/images/2022-09-03-react-native-pokedex/search-functionality.webp)
</div>
...
<div className="thin-media">
  ...
  link/button](/assets/images/2022-09-03-react-native-pokedex/navigation-header.webp)
</div>
      ...
      <ScrollView>
        ...
        <View style={{ padding: 30 }}>
          ...
          <View style={styles.row}>
            ...
            <Text style={{ fontSize: 18 }}>{weight ? weight : 'Loading'}</Text>
          </View>
          <View style={styles.row}>
            <Text style={{ fontSize: 18 }}>Height</Text>
            <Text style={{ fontSize: 18 }}>{height ? height : 'Loading'}</Text>
          </View>
          <View style={styles.row}>
...
<div className="thin-media">
  ...
  Stakataka](/assets/images/2022-09-03-react-native-pokedex/info-page.webp)
</div>
...
<div className="thin-media">
  ...
  expected](/assets/images/2022-09-03-react-native-pokedex/remove-pokemon.webp)
</div>
